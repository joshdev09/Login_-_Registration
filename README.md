This simple login and registration system is made with pure C++. There is no much of an action it only include Login, Registration, forgot password and exit. 
